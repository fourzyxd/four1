...
//global.bg = await (await fetch(img)).buffer()
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'github.com/fourzyxd', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'kuroyama911@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		message: {
			"productMessage": {
				"product": {
					...
					"title": KuroXd, //Kasih namalu 
					"description": "FOUR BOT", 
					"currencyCode": "USD",
	...
	key : {
       ...
       message: {
                    orderMessage: {
                            ...
                            status: 1,
                            surface : 1,
                            message: 'Kuroyama.id', //Kasih namalu
                            orderTitle: tb,
